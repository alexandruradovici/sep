...
const FAULT_RESPONSE: kernel::procs::FaultResponse = kernel::procs::FaultResponse::Panic; //original
...
struct STM32F412GDiscovery {
    ...
    sevenseg:
        &'static sevenseg::SevenSeg<VirtualMuxAlarm<'static, stm32f412g::tim2::Tim2<'static>>>,
}
...
impl Platform for STM32F412GDiscovery {
        ...
        F: FnOnce(Option<&dyn kernel::Driver>) -> R,
    {
        match driver_num {
            ...
            //seven segment display driver
            sevenseg::DRIVER_NUM => f(Some(self.sevenseg)),
            _ => f(None),
        }
    }
}
...
pub unsafe fn reset_handler() {
    ...
    let process_console_uart = static_init!(
        capsules::virtual_uart::UartDevice,
    ...
    kernel::hil::uart::Transmit::set_transmit_client(process_console_uart, process_console);
    kernel::hil::uart::Receive::set_receive_client(process_console_uart, process_console);
    ...
    let led = components::led::LedsComponent::new(components::led_component_helper!(
        ...
        (
          ...
          (
              stm32f412g::gpio::PinId::PA15.get_pin().as_ref().unwrap(),
              kernel::hil::gpio::ActivationMode::ActiveLow
          ),
          (
              stm32f412g::gpio::PinId::PA07.get_pin().as_ref().unwrap(),
              kernel::hil::gpio::ActivationMode::ActiveLow
          ),
          (
              stm32f412g::gpio::PinId::PA06.get_pin().as_ref().unwrap(),
              kernel::hil::gpio::ActivationMode::ActiveLow
          ),
          (
              stm32f412g::gpio::PinId::PA05.get_pin().as_ref().unwrap(),
              kernel::hil::gpio::ActivationMode::ActiveLow
          ) */
    ))
    ...
    let button = components::button::ButtonComponent::new(
        ...
        components::button_component_helper!(
            ...
            (
              ...
              // Shield 1 (left to right)
              (
                  stm32f412g::gpio::PinId::PC01.get_pin().as_ref().unwrap(),
                  kernel::hil::gpio::ActivationMode::ActiveLow,
                  kernel::hil::gpio::FloatingState::PullUp
              ),
              // Shield 2
              (
                  stm32f412g::gpio::PinId::PC03.get_pin().as_ref().unwrap(),
                  kernel::hil::gpio::ActivationMode::ActiveLow,
                  kernel::hil::gpio::FloatingState::PullUp
              ),
              // Shield 3
              (
                  stm32f412g::gpio::PinId::PC04.get_pin().as_ref().unwrap(),
                  kernel::hil::gpio::ActivationMode::ActiveLow,
                  kernel::hil::gpio::FloatingState::PullUp
              ) */
        ),
    ...
    let gpio = GpioComponent::new(
        ...
        components::gpio_component_helper!(
            ...
            13 => stm32f412g::gpio::PinId::PA05.get_pin().as_ref().unwrap(),  //D13

            // arduino shield buttons
            14 => stm32f412g::gpio::PinId::PC01.get_pin().as_ref().unwrap(), // A1
            15 => stm32f412g::gpio::PinId::PC03.get_pin().as_ref().unwrap(), // A2
            16 => stm32f412g::gpio::PinId::PC04.get_pin().as_ref().unwrap()  // A3
    ...
    let hello = static_init!(hello::Hello, hello::Hello::new(grant_hello));
    ...
    let sevenseg = static_init!(
        sevenseg::SevenSeg<VirtualMuxAlarm<'static, stm32f412g::tim2::Tim2>>,
        sevenseg::SevenSeg::new(
            stm32f412g::gpio::PinId::PG12.get_pin().as_ref().unwrap(),
            stm32f412g::gpio::PinId::PG10.get_pin().as_ref().unwrap(),
            stm32f412g::gpio::PinId::PG11.get_pin().as_ref().unwrap(),
            sevenseg_alarm
        )
    );

    use kernel::hil::time::Alarm;
    sevenseg_alarm.set_client(sevenseg);
    ...
    debug!("Yay, booting completed! Entering main loop...");
