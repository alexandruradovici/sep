...
pub unsafe fn reset_handler() {
    ...
    let gpio = GpioComponent::new(
        ...
        components::gpio_component_helper!(
            ...
            // Leds
            14 => stm32f412g::gpio::PinId::PE00.get_pin().as_ref().unwrap(),  // Led1
            15 => stm32f412g::gpio::PinId::PE01.get_pin().as_ref().unwrap(),  // Led2
            16 => stm32f412g::gpio::PinId::PE02.get_pin().as_ref().unwrap(),  // Led3
            17 => stm32f412g::gpio::PinId::PE00.get_pin().as_ref().unwrap()  // Led4
